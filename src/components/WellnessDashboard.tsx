      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="gradient-card border-0 shadow-lg">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-primary mb-2">{mockData.weeklyMood}/5</div>
              <Progress value={(mockData.weeklyMood / 5) * 100} className="mb-2" />
          ...
          <Card className="gradient-card border-0 shadow-lg">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-accent mb-2">{mockData.streakDays} days</div>
          ...
          <Card className="gradient-card border-0 shadow-lg">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-success mb-2">{mockData.totalCheckIns}</div>
          ...
          <Card className="gradient-card border-0 shadow-lg">
            ...
            <CardContent>
              <Badge 
                variant="outline" 
                className={`text-lg px-3 py-1 mb-2 capitalize ${getRiskColor(mockData.riskLevel)}`}
              >
                {mockData.riskLevel}
              </Badge>
        ...
        <Card className="gradient-card border-0 shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl">Recent Mood History</CardTitle>
            ...
            <div className="space-y-4">
              {mockData.recentMoods.map((entry, index) => (
                <div key={index} className="flex items-center justify-between p-4 rounded-xl bg-background/50">
                  ...
                  <div className="flex items-center gap-3">
                    <Progress value={(entry.mood / 5) * 100} className="w-24" />
